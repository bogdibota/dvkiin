...
const InputDateTime: FunctionComponent<
  DVKDateTimeField & PropsWithErrorManagement
> = ({
  name,
  label,
  type,
  ...
  switch (type) {
    case 'date-time':
      return <DateTimePicker ampm={false} {...commonProps} />;
    case 'time':
      return <TimePicker ampm={false} {...commonProps} />;
    case 'date':
